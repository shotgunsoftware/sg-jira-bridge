...
class TestIntegration(TestCase):
    ...
    def _get_jira_key(self, entity):
        ...
        :param dict entity: ShotGrid entity dict with keys type and id.
    ...
    def _test_update_status_from_shotgun(self):
        """
        Ensure updating status in ShotGrid is reflected in JIRA.
        """
    ...
    def _test_update_status_from_jira(self):
        """
        Ensure updating status in JIRA is reflected in ShotGrid.
        """
    ...
    def _test_update_assignment_from_shotgun(self):
        """
        Ensure updating the task_assignees in ShotGrid updates the assignee
        in JIRA.
        """
    ...
    def _test_update_ccs_from_shotgun(self):
        """
        Ensure updating addressings_cc in ShotGrid updates watchers in JIRA.
        """
    ...
    def _test_update_ccs_from_jira(self):
        """
        Ensure updating watchers in JIRA updates the addressing CCs in ShotGrid.
    ...
    def _test_update_description_from_shotgun(self):
        """
        Ensure updating description in ShotGrid is reflected in JIRA.
        """
    ...
    def _test_update_description_from_jira(self):
        """
        Ensure updating description in JIRA is reflected in ShotGrid.
        """
