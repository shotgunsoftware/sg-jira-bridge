...
class TestIntegration(TestCase):
    ...
    JIRA and Flow Production Tracking servers.
    ...
    def _get_jira_key(self, entity):
        ...
        :param dict entity: Flow Production Tracking entity dict with keys type and id.
    ...
    def _create_task(self, name):
        """
        Create a task in Flow Production Tracking.
    ...
    def _test_update_status_from_shotgun(self):
        """
        Ensure updating status in Flow Production Tracking is reflected in JIRA.
        """
    ...
    def _test_update_status_from_jira(self):
        """
        Ensure updating status in JIRA is reflected in Flow Production Tracking.
        """
    ...
    def _test_update_assignment_from_shotgun(self):
        """
        Ensure updating the task_assignees in Flow Production Tracking updates the assignee
        in JIRA.
        """
    ...
    def _test_update_ccs_from_shotgun(self):
        """
        Ensure updating addressings_cc in Flow Production Tracking updates watchers in JIRA.
        """
    ...
    def _test_update_ccs_from_jira(self):
        """
        Ensure updating watchers in JIRA updates the addressing CCs in Flow Production Tracking.
    ...
    def _test_update_description_from_shotgun(self):
        """
        Ensure updating description in Flow Production Tracking is reflected in JIRA.
        """
    ...
    def _test_update_description_from_jira(self):
        """
        Ensure updating description in JIRA is reflected in Flow Production Tracking.
        """
