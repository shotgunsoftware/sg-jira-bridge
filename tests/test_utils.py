...
class TestUtils(TestBase):
    ...
    def test_utf8_to_unicode(self):
        ...
        self.assertIsNotNone(
            re.match(
                "UTF-8 decoded key %s is already present in dictionary being decoded" % UNICODE_STRING,
    ...
    def test_utf8_encode(self):
        ...
        self.assertIsNotNone(
            re.match(
                "UTF-8 encoded key for %s is already present in dictionary being encoded" % UNICODE_STRING,
                cm.exception.message,
            )
        )
        ...
        self.assertEqual(
            res,
            {
                ...
                "blah": [1, 2, 3, 4],
                "%s_bis" % UTF8_ENCODED_STRING: [UTF8_ENCODED_STRING, UTF8_ENCODED_STRING, UTF8_ENCODED_STRING],
            }
        )
        # A list of dictionaries
        d = {
