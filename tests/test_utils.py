...
class TestUtils(TestBase):
    ...
    def test_utf8_decode(self):
        ...
        self.assertIsNotNone(
            re.match(
                "Utf8 decoded key %s is already present in dictionary being decoded" % UNICODE_STRING,
    ...
    def test_utf8_encode(self):
        ...
        self.assertIsNotNone(
            re.match(
                "Utf8 encoded key for %s is already present in dictionary being encoded" % UNICODE_STRING,
                cm.exception.message,
            )
        )
