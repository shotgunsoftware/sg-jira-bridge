...
htmlhelp_basename = 'sg-jira-bridgedoc'
...
latex_documents = [
    (master_doc, 'sg-jira-bridge.tex', u'sg-jira-bridge Documentation',
     u'Autodesk Inc.', 'manual'),
]
...
man_pages = [
    (master_doc, 'sg-jira-bridge', u'sg-jira-bridge Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'sg-jira-bridge', u'sg-jira-bridge Documentation',
     author, 'sg-jira-bridge', 'One line description of project.',
     'Miscellaneous'),
]
