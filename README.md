...
SG Jira Bridge is a simple synchronization setup between SG and Jira. It's designed to get you up and running quickly with basic sync functionality for Tasks, Issues, and Notes.
...
- **`triggers/sg_jira_event_trigger.py`**: A SG event trigger which can be used with the [SG Event Daemon](https://github.com/shotgunsoftware/shotgunEvents)
...
- **`sg_jira`**: Python package for handling the synchronization between SG and Jira.
